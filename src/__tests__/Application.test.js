...
// Mock the axios.delete method using jest.mock
jest.mock('axios');
import { render, waitForElement, fireEvent, getByText, getByAltText, getAllByTestId, getByPlaceholderText, queryByText, queryByAltText } from '@testing-library/react';
